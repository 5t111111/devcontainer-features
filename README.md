...
- **[mise](src/mise)** - mise-en-place CLI installation with GPG and SHA256 verification
- **[safe-chain](src/safe-chain)** - Aikido Safe Chain installation for supply-chain security
